<template>
  <div class="app-container">
    ...
    <div style = "margin-bottom:10px;">    
        ...
        <span style = "font-size:20px;">权限设置树</span>
    </div>
...
export default {
  ...
  methods: {
    ...
    getTree() {
      this.$axios.post(this.HOST + '/api/permission/findAll').then(response => {
    ...
    save() {
      ...
      this.$axios.post(this.HOST + '/api/permission/save', params)
        .then(response => {
          this.getTree()
          document.getElementById('showOrHide').style.display = 'none'
          this.$alert('保存成功', {
